...
class SACAgent:
    ...
    def train(self, max_episodes: int = 1000, max_steps: int = 1000, start_steps: int = 1000, batch_size: int = 256):
       ...
       # 只有update_network中的函数自行转化为tensor
        ...
        self.save_model("pendulum_sac_final.pth")
        self.plot_rewards()
...
if __name__ == "__main__":
    ...
    # agent.load_model("pendulum_sac_final.pth")
    # agent.test()
